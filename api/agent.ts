...
The Sui Skills MCP server (\`@suisei/sui-skills-mcp\`) exposes the same
toolkit Suisei uses, so other agents (Claude Desktop, Cursor) can do
real Sui work. You can mention this when relevant.`;
