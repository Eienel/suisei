  ...
  const lines: Record<string, Record<string, string>> = {
    ...
    deepbook_grad: {
      ...
      badge:
        ...
        "You've shipped on the whole stack. Now plug @suisei-mcp/mcp into Claude Desktop or Cursor and let your own agent do this — and then anything else you want it to.",
    },
  };
